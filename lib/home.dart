...
import 'package:recipe_application/search.dart';
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              if ((searchController.text).replaceAll(" ", "") ==
                                ...
                                Navigator.push(context , MaterialPageRoute(builder: (context) => Search(searchController.text,search)));
                              }
                            },
                            child: Container(
                ...
                Container(
                  child: isLoading ? Container(height: MediaQuery.of(context).size.height - 400,child: Center(child: CircularProgressIndicator())) :  ListView.builder(
                      shrinkWrap: true,
